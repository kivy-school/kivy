...
RELOAD_MODE = bool(int(environ.get('KIVY_RELOAD_MODE', '0')))
...
class BuilderBase(object):
    ...
    def load_file(self, filename, encoding='utf8', reload=RELOAD_MODE, **kwargs):
        ...
        '''
        if reload:
            self.reload_file(filename, encoding, **kwargs)
            return
    ...
    def reload_file(self, filename, encoding='utf8', **kwargs):
        """
